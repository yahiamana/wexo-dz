export const DEFAULT_WEBSITE_TYPES = [
    {
      id: '1',
      slug: 'one-page',
      ...
      priceDZD: 45000,
      icon: 'file',
      imageUrl: '/images/one-page-preview.jpg', // Placeholder, ideally exists or handled
      isPopular: false,
      order: 1,
      isActive: true,
      createdAt: new Date(),
    ...
    },
    {
      ...
      priceDZD: 90000,
      icon: 'building',
      imageUrl: '/images/business-preview.jpg',
      isPopular: true,
      order: 2,
      isActive: true,
      createdAt: new Date(),
    ...
    },
    {
      ...
      priceDZD: 120000,
      icon: 'briefcase',
      imageUrl: '/images/professional-preview.jpg',
      isPopular: false,
      order: 3,
      isActive: true,
      createdAt: new Date(),
